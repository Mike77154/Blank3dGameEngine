...
GTZ89_API int gtz89_profile_from_recipe(const gri89_doc *doc, gtz89_profile *out_profile);
GTZ89_API int gtz89_profile_load_ini(const char *path, gtz89_profile *out_profile);
