...
- ELF `DT_SONAME` is pinned to `libpcx.so.1`.
- exported dynamic symbols are controlled by `exports/pcx.map`.
- `scripts/check_exports.py` verifies the actual export set against `exports/pcx.exports.txt`.
