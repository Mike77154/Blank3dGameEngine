...
def main() -> int:
    ...
    export_text = (root / "include" / "pcx" / "pcx_export.h").read_text(encoding="utf-8")
    win_exports_ok = "WINDOWS_EXPORT_ALL_SYMBOLS" in cmake_text or "__declspec(dllexport)" in export_text
    check("Windows shared-library exports", win_exports_ok, "expected export-all-symbols or explicit dllexport annotations")
