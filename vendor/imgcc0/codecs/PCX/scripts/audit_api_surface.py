...
def main():
    ...
    allowed_local_includes = {f'#include \"{project}_export.h\"', '#include \"pcx_config89.h\"'}
    quoted_includes = [inc for inc in includes if '"' in inc and inc not in allowed_local_includes]
    if quoted_includes:
        ok = False
    ...
    expected_headers = sorted([f'{project}.h', f'{project}_export.h', 'pcx_config89.h'])
