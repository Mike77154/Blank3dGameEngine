                                ...
                                psd89_u32 stride)
{
    ...
    layer->top = 0;
    layer->left = 0;
    layer->bottom = (psd89_s32)height;
    layer->right = (psd89_s32)width;
    layer->channel_count = 4U;
    memcpy(layer->blend_mode, norm, 4U);
    layer->opacity = 255U;
    strncpy(layer->name, "fidelity_v23", PSD89_MAX_NAME_CHARS);
...
int main(void)
{
    static const unsigned char src_r[25] = {
        0U,0U,0U,0U,0U,
        0U,255U,255U,255U,0U,
        0U,255U,255U,255U,0U,
        0U,255U,255U,255U,0U,
        0U,0U,0U,0U,0U
    };
    static const unsigned char src_g[25] = {
        0U,0U,0U,0U,0U,
        0U,64U,64U,64U,0U,
        0U,64U,64U,64U,0U,
        0U,64U,64U,64U,0U,
    ...
    static const unsigned char src_b[25] = {
        0U,0U,0U,0U,0U,
        0U,64U,64U,64U,0U,
        0U,64U,64U,64U,0U,
        0U,64U,64U,64U,0U,
    ...
    static const unsigned char src_a[25] = {
        0U,0U,0U,0U,0U,
        0U,255U,255U,255U,0U,
        0U,255U,255U,255U,0U,
        0U,255U,255U,255U,0U,
    ...
    init_rgb_layer_rect(&doc.layers[0], src_r, src_g, src_b, src_a, 5U, 5U, 5U);
    ...
    doc.layers[0].lrfx.inner_glow.opacity = 120U;
    ...
    rc = psd89_write_path("examples/example_fidelity_roundtrip_v23.psd", &doc);
    if (rc != PSD89_OK) {
    ...
    rc = psd89_read_path(&parsed, "examples/example_fidelity_roundtrip_v23.psd");
    if (rc != PSD89_OK) {
        fprintf(stderr, "read failed: %s\n", psd89_error_string(rc));
        return 1;
    }

    printf("fidelity_roundtrip_v23: wrote examples/example_fidelity_roundtrip_v23.psd ");
