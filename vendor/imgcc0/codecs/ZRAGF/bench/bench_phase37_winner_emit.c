...
int main(void)
{
    ...
    ms_split = bench_ms(zragf_split_size, buf, n, 10, &out_split);
    ms_zlib = bench_ms(zlib_size_once, buf, n, 10, &out_zlib);
    printf("phase37 mixed raw: single=%lu split=%lu zlib=%lu delta_single=%ld delta_zlib=%ld ms_single=%d ms_split=%d ms_zlib=%d\n",
