                                   ...
                                   int repeat, int warmup, int builtins, int file_count)
{
    ...
    fprintf(f, "# ZRAGFLIB public benchmark suite (phase 69)\n\n");
...
int main(int argc, char **argv)
{
    ...
    use_builtins = 1;
    quick = 0;
    csv_path = "phase69_public.csv";
    summary_path = "phase69_public.md";
    file_arg_start = argc;
    ...
    printf("phase69 public bench rows=%d csv=%s summary=%s\n", row_count, csv_path, summary_path);
    zragf_p68_free_datasets(datasets, dataset_count);
    return 0;
}
