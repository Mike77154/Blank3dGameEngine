/* scanemu89.h - C89 fixed-point, backend-agnostic capture of symbolic hardware tokens
   SPDX-License-Identifier: MIT
*/
#ifndef SCANEMU89_H_INCLUDED
#define SCANEMU89_H_INCLUDED
...
#define SCANEMU89_FIXED_ONE 65536L
#define SCANEMU89_FIXED_HALF 32768L
...
typedef struct scanemu_token {
    ...
    scanemu_i32 value_q16;  /* Q16.16 axis threshold / wheel magnitude */
    scanemu_u32 extra;      /* e.g. hat dir mask, modifiers, vendor info */
} scanemu_token;

/* The "how" we heard it (input event). scanemu89 does NOT implement key states;
...
typedef struct scanemu_event {
    ...
    /* Optional: for TEXT events, backends may pass ASCII/UTF-8 bytes via extra;
       scanemu89 itself ignores it unless you use SCANEMU_LISTEN_TEXT. */
...
/* Feed result (what happened after scanemu89_feed). */
typedef enum scanemu89_feed_result {
...
typedef struct scanemu_ctx {
    ...
    scanemu_i32      axis_threshold_q16;
...
/* Initialize scanemu89 with caller-provided storage (no malloc inside scanemu). */
