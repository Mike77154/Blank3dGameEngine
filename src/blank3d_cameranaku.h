...
/* Legacy selectors remain as compatibility aliases. New code selects a
 * profile by id/index from individual INI files in config/cameras. */
#define B3D_CNK_CAMERA_FPS 1
#define B3D_CNK_CAMERA_TPS 2
#define B3D_CNK_CAMERA_OTS 3
...
/* Legacy fallback configurator. It edits the in-memory fallback profiles;
 * external INI profiles remain the primary path. */
